...
This repository contains the source code and configuration for a ROS 2 Jazzy line-follower robot. It supports both IR-based and Computer Vision-based line following.
