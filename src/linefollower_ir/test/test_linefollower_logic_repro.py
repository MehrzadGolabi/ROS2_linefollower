...
class TestIrLogicRepro(unittest.TestCase):
    ...
    def test_repro_right_offset_11101(self):
        ...
        print(f'\nPattern 11101 -> linear.x: {twist.twist.linear.x},'
              f' angular.z: {twist.twist.angular.z}')
        ...
        self.assertGreater(twist.twist.linear.x, 0.05,
                           'Linear velocity too low to overcome stiction')
    ...
    def test_repro_left_offset_10111(self):
        ...
        print(f'\nPattern 10111 -> linear.x: {twist.twist.linear.x},'
              f' angular.z: {twist.twist.angular.z}')
