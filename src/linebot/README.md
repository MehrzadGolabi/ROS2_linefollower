...
For previous licensing history, see [LICENSE.previous.md](https://github.com/YJ0528/linebot/blob/main/LICENSE.previous.md)

<br>

<div align="center">
	<img src="https://github.com/YJ0528/linebot/blob/main/visual_demos/robot_visual.jpg" height="350">
	<br>
	<h2> Differential Drive Robot using ROS 2 Jazzy Jalisco </h2>
	<a href="https://github.com/YJ0528/linebot/blob/main/LICENSE">
...
You can see the demo [here](https://github.com/YJ0528/linebot/blob/main/README.md#demo)
...
Additionally, consider to install [Terminator](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#terminator), which is a useful tool to use with ROS 2.

<br>

## Setting Up ROS 2 Workspace and Installed Requied Packages
Before we start, see [ROS 2 Packages: A Brief Introduction](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#introduction) for the differences between the <ins>**binary installation**</ins> and <ins>**build from source**</ins>
...
3.	 Follow to the insturction at [**Install ROS 2 Packages**](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#install-ros-2-package) to install all the necessary packages.
...
3.	Launch Simulation Control and SLAM
	...
	*	To run the control with `online_async_slam` from `slam_toolbox`, open a new terminal, source the local workspace and enter:
			...
			ros2 launch linebot sim_control_station.launch.py use_slam_option:=online_async_slam
	*	For `mapper_params_localization` from `slam_toolbox`:
	
	 		ros2 launch linebot sim_control_station.launch.py use_slam_option:=mapper_params_localization
	 	*	To change the map to load, open the params file at [`./src/linebot/config/mapper_params_localization.yaml`](https://github.com/YJ0528/linebot/blob/aa18371856751b270af9280b53b87c7f5f3a6bcf/config/mapper_params_localization.yaml#L18), replace the value corresponding `map_file_name` with the desired directory.
	*	For `AMCL` from `nav2`:
	
			ros2 launch linebot sim_control_station.launch.py use_slam_option:=amcl map:=./src/linebot/maps/sample_map.yaml
	 	*	To change the map to load, replace the default value corresponding to [`map`](https://github.com/YJ0528/linebot/blob/aa18371856751b270af9280b53b87c7f5f3a6bcf/launch/sim_control_station.launch.py#L27) with the desired directory.

5.	Alternatively, we can just run the teleoperation only using:

		ros2 launch linebot joystick_teleop.launch.py
### Additional Notes:
Refer to:
*	[ros_gz_bridge](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#ros_gz_bridge) if a topic could not be send or recived between ROS 2 and Gazebo.
*	[How a ROS 2 Topic Is Received By a Node](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#how-a-ros-2-topic-is-received-by-a-node) if you suspect topics are not being published or subscribed to properly
*	[How to Check ROS 2 Node Parameter Name using Command Line](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#how-to-check-ros-2-node-parameter-name-using-command-line) if you want to check if the parameters from `.yaml` file is loaded to the node properly.
...
<div align="center">
	...
	<img src="https://github.com/YJ0528/linebot/blob/main/visual_demos/robot_hardware.jpg" height="500">
	<p>Robot Hardware and Circuit Connection Setup</p>
</div>

***<ins>IMPORTANT:</ins>** Please exercise the proper safety for lipo battery, I have included some precautions at [Lipo Battery Safety Precautions](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#lipo-battery-safety-precautions).
...
see also: [Recommanded Components for Wiring and Robot Chasis (Optional)](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#recommanded-components-for-wiring-and-robot-chasis-optional).
...
*	If you never install Ubuntu 24.04 using rpi-imager before, see: [RPI5: Flash Ubuntu to SD Card](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#rpi5-flash-ubuntu-to-sd-card).
...
2.	 Follow to the insturction at [**Install ROS 2 Packages**](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#install-ros-2-package) to install all the necessary packages in Raspberry Pi.
		*	You need to install all the packages listed except `ros_gz`.

<ins>**Flashing Code to ESP32**</ins>

In addition, you need to Flash the driver code to your ESP32, see [Install and Flash Microcontroller Driver code](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#install-and-flash-microcontroller-driver-code)
...
1.	Ensure the Raspberry Pi USB device port number matched the value declared:
	...
	*	`/dev/ttyUSB0` for the lidar serial; located at [`./src/linebot/launch/robot.launch.py/declare_lidar_serial_port`](https://github.com/YJ0528/linebot/blob/aa18371856751b270af9280b53b87c7f5f3a6bcf/launch/robot.launch.py#L53).
	*	`/dev/ttyUSB1` for the ESP32; located at [`./src/linebot/description/ros2_control.xacro/RobotSystem/device`](https://github.com/YJ0528/linebot/blob/aa18371856751b270af9280b53b87c7f5f3a6bcf/description/ros2_control.xacro#L11).
	*	To check or troubleshoot the USB connection in Raspberry Pi, see [RPI5: Add USB Access for Raspberry Pi](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#rpi5-add-usb-access-for-raspberry-pi).
...
2.	Connects to the Raspberry Pi from your server machine using `openssh-server`. Open a terminal in the server machine, enter:
	 ...
	 *	If you never install or use `openssh-server` before,see [SSH Access to Remote Machine- Connect Remote Machine via Terminal](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#connecting-to-the-remote-machine-in-terminal).  
...
5.	Run the robot:
		...
		ros2 launch linebot robot.launch.py
...
6.	Launch Robot Control with SLAM or Localization
	...
	*	To run the control with `online_async_slam` from `slam_toolbox`, open a new terminal in your server machine, source the local workspace and enter:
			...
			ros2 launch linebot robot_remote_station.launch.py use_slam_option:=online_async_slam
	*	For `mapper_params_localization` from `slam_toolbox`:
	
	 		ros2 launch linebot robot_remote_station.launch.py use_slam_option:=mapper_params_localization
	 	*	To change the map to load, open the params file at [`./src/linebot/config/mapper_params_localization.yaml`](https://github.com/YJ0528/linebot/blob/aa18371856751b270af9280b53b87c7f5f3a6bcf/config/mapper_params_localization.yaml#L18), replace the value in `map_file_name` with the desired directory.
	*	For `AMCL` from `nav2`:
	
			ros2 launch linebot robot_remote_station.launch.py use_slam_option:=amcl map:=./src/linebot/maps/sample_map.yaml
	 	*	To change the map to load, replace the default value of [`map`](https://github.com/YJ0528/linebot/blob/aa18371856751b270af9280b53b87c7f5f3a6bcf/launch/robot_remote_station.launch.py#L27) with the desired directory.
...
<div align="center">
	...
	<img src="https://github.com/YJ0528/linebot/blob/main/visual_demos/SLAM_demostration-ezgif.com-video-to-gif-converter.gif" height="400">
	<br><br>	
 	<h3> Nav2 Navigation using SLAM Toolbox Localization (5x speed)</h3>
	<img src="https://github.com/YJ0528/linebot/blob/main/visual_demos/Nav2_demostration-ezgif.com-video-to-gif-converter.gif" height="400">	
</div>
