### List of Content:
*	[Introduction](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#introduction)
*	[Install ROS 2 Packages](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#install-ros-2-package)
*	[Install and Flash Microcontroller Driver code](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#install-and-flash-microcontroller-driver-code)
...
*	[Explaination on ROS 2 Packages](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#explanation-on-ros-2-packages)
...
**For simulation only:**
*	[ros_gz](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#ros_gz)
*	[ros2_control](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#ros2_control)
*	[nav2 stack](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#nav2)
*	[twist_mux](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#twist_mux)
*	[twist_stamper](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#twist_stamper)

**For driver and hardware interface (in addition to the file listed for simulation, except `ros_gz`):**
*	[diffdrive_arduino](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#diffdrive_arduino)
*	[serial](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#serial)
*	[sllidar_ros2](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#sllidar_ros2)
...
If the machine consist of 8GB RAM or less, expanding the virtual RAM with the instruction [How to Increase Virtual Memory](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#how-to-increase-virtual-memory).
...
*	To check the parameter name, see [Useful Tips: Check node parameter name in command line](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#how-to-check-ros-2-node-parameter-name-using-command-line) 
...
2.	Clone the package from github:
  	...
  	*	I have created a fork for the pr_52, which provides the stamped cmd_vel option.
   	*	Alternatively, user can still convert unstamped cmd_vel to stamped using [twist_stamper](https://github.com/YJ0528/linebot/blob/main/Package_Installation_Instruction.md#twist_stamper).
3.	Build the package:
...
4.	The default port number starts from `dev/ttyUSB0`, `dev/ttyUSB0`..., check serial port using
		...
		ls -l /dev/ttyUSB* 
6.	If the ESP32 is plugged into the serial port but the it is not recognized by the IDE, see [RPI5: Add USB Access for Raspberry Pi](https://github.com/YJ0528/linebot/blob/main/Tips_and_Troubleshooting.md#rpi5-add-usb-access-for-raspberry-pi).
