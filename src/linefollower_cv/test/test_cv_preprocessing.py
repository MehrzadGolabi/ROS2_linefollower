...
class TestCvPreprocessing(unittest.TestCase):
    ...
    def test_morphology_pre_canny(self):
        ...
        msg = 'Morphological opening should have filled the 10px gap in black line'
        self.assertEqual(preprocessed[50, 50], 0, msg)
    ...
    def test_adaptive_canny_thresholds(self):
        ...
        msg = 'Bright image should have higher thresholds than dark image'
        self.assertGreater(low_b, low_d, msg)
        self.assertGreater(high_b, high_d, msg)
    ...
    def test_morphology_post_canny(self):
        ...
        with patch('cv2.morphologyEx', wraps=cv2.morphologyEx) as mock_morph:
            ...
            msg_err = 'cv2.morphologyEx should be called for post-Canny morphology'
            self.assertTrue(mock_morph.called, msg_err)
